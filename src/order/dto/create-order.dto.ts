...
export class CreateOrderDto {
  ...
  @ApiProperty({
    description:
      'Запланированная дата и время доставки (ISO 8601). Если не указано, автоматически устанавливается текущее время + 1 час. Можно указать любое время (например, 11:00 текущего дня, даже если сейчас 16:30)',
